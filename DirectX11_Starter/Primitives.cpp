		...
		Material* mat, Material* normalMap, Camera* camera, XMFLOAT4 color)
{
	Vertex verts[] =
	{
		{ XMFLOAT3(-0.5, 0.5, 0.5), color, XMFLOAT2(0, 0), XMFLOAT3(-1, 1, 1), XMFLOAT3(2, 0.5, 1) },
		{ XMFLOAT3(0.5, 0.5, 0.5), color, XMFLOAT2(1, 0), XMFLOAT3(1, 1, 1), XMFLOAT3(2, 0.5, -1) },
		{ XMFLOAT3(0.5, -0.5, 0.5), color, XMFLOAT2(1, 1), XMFLOAT3(1, -1, 1), XMFLOAT3(2, -0.5, -1) },
		{ XMFLOAT3(-0.5, -0.5, 0.5), color, XMFLOAT2(0, 1), XMFLOAT3(-1, -1, 1), XMFLOAT3(2, -0.5, 1) },
		{ XMFLOAT3(-0.5, 0.5, -0.5), color, XMFLOAT2(1, 0), XMFLOAT3(-1, 1, -1), XMFLOAT3(-2, 0.5, 1) },
		{ XMFLOAT3(0.5, 0.5, -0.5), color, XMFLOAT2(0, 0), XMFLOAT3(1, 1, -1), XMFLOAT3(-2, 0.5, -1) },
		{ XMFLOAT3(0.5, -0.5, -0.5), color, XMFLOAT2(0, 1), XMFLOAT3(1, -1, -1), XMFLOAT3(-2, -0.5, -1) },
		{ XMFLOAT3(-0.5, -0.5, -0.5), color, XMFLOAT2(1, 1), XMFLOAT3(-1, -1, -1), XMFLOAT3(-2, -0.5, 1) }
