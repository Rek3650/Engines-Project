...
bool Keyboard::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	HRESULT result;
	...
	//reached the end of INIT -> function ran correctly.
	return true;
}
...
//Actually gets the keyboard state and reads it into our array.
...
void Keyboard::GetMouseLocation(int& mouseX, int& mouseY)
{
	mouseX = m_mouseX;
	mouseY = m_mouseY;
	return;
